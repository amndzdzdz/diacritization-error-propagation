...
def main() -> None:
    ...
    print()
    if excess <= 0:
        print("  READ: disagreement is at or below the model's own known error rate.")
        print("  There is no headroom for a meaningful mispronunciation base rate.")
        print("  => docs/msa-arm.md §3.3 option 2 (label-path only) is likely forced.")
    else:
